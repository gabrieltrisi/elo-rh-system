...
const Leave = () => {
  ...
  const stats = useMemo(() => {
    return {
      ...
      finished: leaves.filter(
        (item) => (item.status || '').toLowerCase() === 'finalizado'
      ).length,
      inss: leaves.filter((item) => (item.type || '').toLowerCase() === 'inss')
        .length,
    };
  }, [leaves]);
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-slate-500'>
                      Registre um afastamento vinculado ao colaborador.
                    </p>
                  </div>
                </div>
                ...
                <div className='space-y-6'>
                  <section className='rounded-2xl border border-slate-200 bg-white p-5 shadow-sm'>
                    <div className='mb-5'>
                      ...
                      <p className='mt-1 text-sm text-slate-500'>
                        Selecione o colaborador relacionado ao afastamento.
                      </p>
                    </div>
